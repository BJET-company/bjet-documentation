...
Конструктор Друкованих Форм  -  це модуль для Odoo (Community та Enterprise), який надає інструменти для створення, редагування та керування друкованими формами (рахунками, актами, видатковими накладними тощо).
