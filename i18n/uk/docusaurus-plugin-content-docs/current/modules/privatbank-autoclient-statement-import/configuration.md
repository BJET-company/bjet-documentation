...
## Налаштування журналу Приватбанку
...
:::info Примітка
Якщо пізніше вибрати інший варіант Банківська виписка — вкладка ПриватБанк приховається.
:::

### Крок 2: Налаштування вкладки ПриватБанк

У вкладці **ПриватБанк** заповніть поле:
...
та вставте у поле Токен Автоклієнт ПриватБанк24
...
Відкрийте банківський журнал та перейдіть на закладку **ПриватБанк** → натисніть **Імпорт виписок**.
